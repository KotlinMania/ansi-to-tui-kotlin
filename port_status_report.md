...
**Source:** src
**Target:** src/commonMain/kotlin/ansitotui
...
| Average documentation similarity | 0.65 | doc text cosine |
...
| Target units (paired) | 6 | - |
| Target files (total) | 6 | - |
...
|------|--------|--------|---------------------|-----------|-------------------|-------|---------------|-------|----------------|----------|
| 1 | `lib` | `ansitotui.IntoText` | 0.25 | 2/2 matched (target 5) | _none_ | 1/1 matched | _none_ | - | 0 | 307.5 |
| 2 | `error` | `ansitotui.Error` | 0.28 | 1/1 matched (target 4) | _none_ | 1/1 matched (target 5) | _none_ | - | 0 | 1000207.2 |
| 3 | `parser` | `ansitotui.Parser` | 0.46 | 16/16 matched (target 18) | _none_ | 3/3 matched (target 4) | _none_ | 2/2 | 0 | 1905.4 |
...
**Documentation coverage:** 194 / 290 lines (67%)
