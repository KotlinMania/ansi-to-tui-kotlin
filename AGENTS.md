# Agent guide - ansi-to-tui-kotlin

This file is the quick-reference operating contract for ansi-to-tui-kotlin. The longer
...
ansi-to-tui-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`ansi-to-tui`](./README.md). Upstream Rust is the behavioral oracle while the
