...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `AnsiToTui.swiftmodule/`
...
//      `import AnsiToTui` above would fail at compile time.
//
//   2. The static archive `libAnsiToTui.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "AnsiToTui" }` and
//      `flattenPackage = "io.github.kotlinmania.ansitotui"` configuration in
...
//      via the `AnsiToTuiLibrary` product.
//
...
final class AnsiToTuiExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "AnsiToTui swift module imported cleanly")
    }
}
